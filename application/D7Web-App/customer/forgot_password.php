...
if (isset($_POST['submit'])) {
    ...
    if($select_email->rowCount() > 0){
        $update_verification = $conn->prepare("UPDATE `customers` SET verification =? WHERE email_address = ?");
        ...
        try {
            ...
            $mail->Body    = 'Hi, it seems that you have forgotten your D7 account password. To reset it, here is the verification link: <b><a href="http://localhost/D7Web-App/customer/change_password.php?reset='.$verification.'">
                http://localhost/D7Web-App/customer/change_password.php?reset='.$verification.'</a></b>';
            $mail->send();
