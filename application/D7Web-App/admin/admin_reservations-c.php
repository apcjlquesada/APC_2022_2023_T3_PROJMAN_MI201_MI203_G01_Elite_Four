...
<?php
    ...
    $offset = ($page - 1) * $limit;
     ...
     // build SQL query
     $sql = "SELECT * FROM `reservations` WHERE CONCAT(`customer_name`, `service_type`, `car_model`, `customer_number`) LIKE :search_query AND `status` = 'CANCELLED' ";
     ...
     $total_records = $conn->prepare("SELECT COUNT(*) FROM `reservations` WHERE CONCAT(`customer_name`, `service_type`, `car_model`, `customer_number`) LIKE :search_query AND `status` = 'CANCELLED' ");
...
?>
 ...
 <div class="search-container">
    <form action="admin_reservations-c.php" method="GET" class="search" id="search-form" style="bottom: 14rem;" >
        ...
        <table class="reservations-display-table">
            ...
            <form action="" method="POST">
                ...
                <?php
                    ...
                    echo '<tr><td colspan="9" style="width: 100%; font-size: 2rem; text-align: center; padding: 1rem; color: red;">No Cancelled Reservations Yet...</td></tr>';
                }
                ?>
        </table>
    </div>
